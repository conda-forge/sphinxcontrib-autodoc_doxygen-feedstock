About sphinxcontrib-autodoc_doxygen-feedstock
=============================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinxcontrib-autodoc_doxygen-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1954&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinxcontrib-autodoc_doxygen-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinxcontrib-autodoc_doxygen` can be installed with `conda`:
...
```
mamba install sphinxcontrib-autodoc_doxygen
```

It is possible to list all of the versions of `sphinxcontrib-autodoc_doxygen` available on your platform with `conda`:
...
```
mamba search sphinxcontrib-autodoc_doxygen --channel conda-forge
```
...
mamba repoquery search sphinxcontrib-autodoc_doxygen --channel conda-forge

# List packages depending on `sphinxcontrib-autodoc_doxygen`:
mamba repoquery whoneeds sphinxcontrib-autodoc_doxygen --channel conda-forge

# List dependencies of `sphinxcontrib-autodoc_doxygen`:
mamba repoquery depends sphinxcontrib-autodoc_doxygen --channel conda-forge
```
